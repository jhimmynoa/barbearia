...
const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#050505]">
        ...
        <div className="flex-grow flex flex-col items-center justify-center text-center relative z-10 px-4 mt-20">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 text-xs md:text-sm tracking-[0.2em] text-gray-400 mb-6">
            <div className="flex items-center gap-2">
              <span>DESDE</span>
              <span className="text-orange-500 font-bold text-sm md:text-base drop-shadow-[0_0_10px_rgba(249,115,22,0.8)]">ESTÚDIO DE TATUAGEM</span>
            </div>
            <span>MM XVI</span>
          </div>
          <p className="text-gray-300 italic max-w-md mx-auto mb-10 text-sm md:text-base font-light px-4">
            A Barbearia Premium é o local ideal para cuidar do seu visual e estilo na sua cidade.
          </p>
          <button 
            onClick={() => navigate('/calendar')}
      ...
      <section className="py-20 bg-background-dark relative border-t border-white/5">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-bold text-accent-gold mb-4">Nossos Serviços</h2>
            <p className="text-gray-400 text-sm tracking-wide">Experiência premium em cada atendimento</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="group bg-card-dark border border-card-border p-8 hover:border-accent-gold transition-colors duration-300 rounded-sm">
              <div className="w-12 h-12 flex items-center justify-center border border-gray-700 text-accent-gold mb-6 group-hover:border-accent-gold transition-colors">
              ...
              <p className="text-accent-gold font-bold text-2xl">R$ 60</p>
            </div>
            <div className="group bg-card-dark border border-card-border p-8 hover:border-accent-gold transition-colors duration-300 rounded-sm">
              <div className="w-12 h-12 flex items-center justify-center border border-gray-700 text-accent-gold mb-6 group-hover:border-accent-gold transition-colors">
              ...
              <p className="text-accent-gold font-bold text-2xl">R$ 45</p>
            </div>
            <div className="group bg-card-dark border border-card-border p-8 hover:border-accent-gold transition-colors duration-300 rounded-sm">
              <div className="w-12 h-12 flex items-center justify-center border border-gray-700 text-accent-gold mb-6 group-hover:border-accent-gold transition-colors">
              ...
              <p className="text-accent-gold font-bold text-2xl">R$ 95</p>
            </div>
            <div className="group bg-card-dark border border-card-border p-8 hover:border-accent-gold transition-colors duration-300 rounded-sm">
              <div className="w-12 h-12 flex items-center justify-center border border-gray-700 text-accent-gold mb-6 group-hover:border-accent-gold transition-colors">
              ...
              <p className="text-accent-gold font-bold text-2xl">R$ 70</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-background-dark">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-bold text-accent-gold mb-4">Nosso Trabalho</h2>
      ...
      <section className="py-20 bg-background-dark border-b border-white/5">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-display font-bold text-accent-gold mb-4">O que dizem nossos clientes</h2>
            <p className="text-gray-400 text-sm tracking-wide">Satisfação garantida em cada atendimento</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            <div className="bg-card-dark border border-card-border p-8 rounded-sm">
              <div className="flex gap-1 text-accent-gold text-xs mb-4">
              ...
              <p className="text-accent-gold font-bold text-sm uppercase">Carlos Silva</p>
            </div>
            <div className="bg-card-dark border border-card-border p-8 rounded-sm">
              <div className="flex gap-1 text-accent-gold text-xs mb-4">
                <i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i>
              ...
              <p className="text-accent-gold font-bold text-sm uppercase">Rafael Santos</p>
            </div>
            <div className="bg-card-dark border border-card-border p-8 rounded-sm">
              <div className="flex gap-1 text-accent-gold text-xs mb-4">
                <i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i>
              ...
              <p className="text-accent-gold font-bold text-sm uppercase">Marcos Oliveira</p>
            </div>
            <div className="bg-card-dark border border-card-border p-8 rounded-sm">
              <div className="flex gap-1 text-accent-gold text-xs mb-4">
                <i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i><i className="fa-solid fa-star"></i>
              ...
              <p className="text-accent-gold font-bold text-sm uppercase">Lucas Ferreira</p>
            </div>
          </div>
        </div>
      </section>

      <section className="py-20 grid-bg-metal relative overflow-hidden flex justify-center items-center">
      ...
      <section className="relative py-24 overflow-hidden flex items-center justify-center bg-[#050505]">
         {/* Neon Grid Background for Bottom Section */}
        ...
        <div className="w-full max-w-2xl px-4 relative z-10">
          ...
          <div className="bg-[#0f0f0f]/80 backdrop-blur-md rounded-lg p-10 md:p-14 text-center shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/10 relative overflow-hidden">
            ...
            <h3 className="text-3xl md:text-5xl font-display font-bold text-white mb-2">
              Agende <span className="text-primary">Seu Horário</span>
            </h3>
            <p className="text-gray-400 text-sm md:text-base mb-10 max-w-md mx-auto leading-relaxed">
              Pronto para sua próxima tatuagem ou corte? Reserve sua visita agora!
            </p>
            <button 
                onClick={() => navigate('/calendar')}
                className="bg-primary hover:bg-orange-600 text-black font-bold py-4 px-10 rounded text-lg shadow-[0_0_20px_rgba(249,115,22,0.4)] transition-all transform hover:-translate-y-1 w-full md:w-auto">
              Fazer Agendamento
            </button>
          </div>
        </div>
